...
namespace tests\codeception\cdn\models;

use Yii;
use tests\codeception\cdn\unit\DbTestCase;
use cdn\models\PasswordResetRequestForm;
	...
	public function fixtures()
	{
		return [
			'user' => [
				...
				'dataFile' => '@tests/codeception/cdn/unit/fixtures/data/models/user.php'
			],
		];
	}
